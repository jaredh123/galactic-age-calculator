...
describe('GalacticAgeCalculator', function() {
  ...
  it('should test for user birth day "d1"', function() {
    let galacticAgeCalculator = new GalacticAgeCalculator(1, 2, 3, 0, 5, 1, 2, 3);
  ...
  it('should test if "lifeDuration(d1, m1, yr1) returns valid response"', function() {
    let galacticAgeCalculator = new GalacticAgeCalculator(1, 2, 3, 0, 5, 25, 2, 2019);
    let lifeDuration = galacticAgeCalculator.lifeDuration(galacticAgeCalculator.d1, galacticAgeCalculator.m1, galacticAgeCalculator.yr1, galacticAgeCalculator.currentDate, galacticAgeCalculator.currentMonth, galacticAgeCalculator.currentYear).toFixed(2);
  ...
  it('should test for proper response for average health after life expectancy', function() {
    ...
    let planet = galacticAgeCalculator.planet(celestialBody);
    let yearMultiplier = galacticAgeCalculator.yearMultiplier(celestialBody);
    let lifeDuration = parseFloat(galacticAgeCalculator.lifeDuration(galacticAgeCalculator.d1, galacticAgeCalculator.m1, galacticAgeCalculator.yr1, galacticAgeCalculator.currentDate, galacticAgeCalculator.currentMonth, galacticAgeCalculator.currentYear).toFixed(2));
